...
<p align="center">	
  ...
  <img alt="Repository size" src="https://img.shields.io/github/repo-size/marcusv77/app-flutter-imc?color=30416A&label=Respo%20size">
...
```bash
# Clone Repository
$ git clone https://github.com/marcusv77/app-flutter-imc.git
```
